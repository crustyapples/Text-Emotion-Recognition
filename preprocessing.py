...
with open('/Users/advait/Desktop/gitpositories/SC4001-Assignment-2/Text-Emotion-Recognition/emo/emo-train.json') as file:
    train_data = pd.DataFrame(json.load(file))
    
with open('/Users/advait/Desktop/gitpositories/SC4001-Assignment-2/Text-Emotion-Recognition/emo/emo-test.json') as file:
